...
export function generateReportHtml(args: {
  ...
  <div class="sheet">
    ...
    <div class="body">
      ...
      <table><tr><th>Score</th><th>Level</th><th>Up to</th><th>Yearly cost</th></tr>${bandRows}</table>
